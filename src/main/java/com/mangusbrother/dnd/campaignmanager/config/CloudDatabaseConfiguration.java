...
@Configuration
@EnableMongoRepositories("com.mangusbrother.dnd.campaignmanager.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.mangusbrother.dnd.campaignmanager.config.dbmigrations");
